	      	...
	      	<div class="row">
		        <div class="col-12">
		          	<div class="card mb-3">
				        ...
				        <div class="card-body">
							<form method="post" action="{{url('superadmin/updatekuesadmin/'.$kues->id)}}" enctype="multipart/form-data">
								{{csrf_field()}}
								...
								<p>F. JUMLAH PEMENANG LOMBA KRENOVA TINGKAT PROVINSI</p>
									<div class="form-group">
									    <label for="dimana">Jumlah pemenang Lomba Krenova di tingkat Provinsi Tahun 2018 </label>
									     <input type="text" class="form-control" id="ide" placeholder="Diisi oleh BAPPEDA Provinsi" name="pemenang_provinsi" value="{{isset($kues->pemenang_provinsi)?$kues->pemenang_provinsi:''}}" >
									</div>
									<div class="form-group">
