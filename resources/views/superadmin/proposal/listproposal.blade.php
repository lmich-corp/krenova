										...
										<tbody>
							                ...
							                <tr>
											  ...
											  <td >
													...
													<span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Surat Pengantar Proposal">
													@foreach($p->admin->pengantarkota as $pengantar)
														<a href="{{url('suratpengantarkota/'.$pengantar->nama_surat)}}" class="btn btn-danger"><i class="fa fa-print"></i> </a>
													@endforeach
													</span>
													<span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Surat Penyataan Keaslian">
													@foreach($p->proposal as $pengantar)
														<a href="{{url('file/'. $pengantar->suratpengantar_name)}}" class="btn btn-primary"><i class="fa fa-print"></i> </a>
													@endforeach
													</span>
												</td>
											</tr>
