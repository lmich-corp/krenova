                            ...
                            <div class="tab-content" id="myTabContent">    
                                ...
                                <div class="tab-pane fade" id="proposal" role="tabpanel" aria-labelledby="proposal-tab">
                                    ...
                                    {{--  <form>  --}}
                                        ...
                                        <button type="submit" value="" name="" class="btn btn-default" disabled>Cetak</button> <button tyoe="submit" class="btn btn-success" id="lanjutkan_pendaftaran">Approve</button> 
                                    {{--  </form>  --}}
                                </div>
                            </div>
                        </form>
