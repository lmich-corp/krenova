...
<head>
	...
	<body>
		...
		<p align="center">Peserta Kelompok </p>
			...
			<tr>
				<td>Nama Kelompok </td>
				<td >: {{ $inventor->nama_kelompok }}</td>
			</tr>
			<tr>
				<td>Ketua</td>
				<td >: {{ $inventor->nama_ketua }} </td>
			</tr>
			<tr>
				<td>Alamat </td>
				<td >: {{ $inventor->alamat_kelompok }} </td>
			</tr>
			<tr>
				<td >Kab/Kota</td>
				<td >: {{ $inventor->nama_ketua!=''?$inventor->kabupaten:'' }} </td>
			</tr>
			<tr>
				<td>No Telp/HP Ketua</td>
				<td >: {{ $inventor->no_telp_kelompok }} </td>
			</tr>
			<tr>
				<td>Alamat Email </td>
				<td >: {{ $inventor->email_kelompok }} </td>
			</tr>
			<tr>
			<td >
