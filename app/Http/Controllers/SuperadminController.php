...
class SuperadminController extends Controller
{
    ...
    public function listproposal()
    {
        ...
        // $profils = $profilsall->proposal->where('status', '1')->get();
    ...
    {   
        ...
        $pdf = PDF::loadView('superadmin.laporan.cetakdaftarpeserta', compact('profils')) 
                ->setPaper('a4', 'potrait' );
    ...
    public function updatekuesadmin(Request $request, $id)
    {
        $kues = Kuesadmin::find($id);
        $kues->pemenang_provinsi = $request->input('pemenang_provinsi');
        $kues->update();

        return redirect('/superadmin/daftarkabupaten')->with('success', 'Saved');
    }
